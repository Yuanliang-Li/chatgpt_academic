...
def get_functionals():
    return {
        ...
        "中译英": {
            "Prefix":   r"Please translate the following paragraphs to English:" + "\n\n",
            "Suffix":   r"",
        },
        "学术中译英": {
            "Prefix":   r"Please translate the following paragraphs to English with academic writing, and provide some related authoritative examples:" + "\n\n",
            "Suffix":   r"",
        },
        "英译中": {
            "Prefix":   r"请翻译成中文：" + "\n\n",
